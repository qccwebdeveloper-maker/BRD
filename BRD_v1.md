...
|---|-----------|-----------|----------------------------|
| BO-1 | Monetise buyer enquiries through subscription packages and pay-per-lead | Primary revenue model | Subscription + lead-credit revenue, ARPU |
| BO-2 | Maximise qualified lead volume and distribution efficiency | Marketplace liquidity | Leads generated, % distributed, distribution latency |
| BO-3 | Improve buyer–seller match quality | Retention on both sides | Lead→contact→conversion rates |
| BO-4 | Build trust via verification, reviews, and quality scoring | Credibility differentiates from unverified channels | % verified sellers, avg. product quality score |
| BO-5 | Enable scalable operations through the Admin Panel | Control cost-to-serve as GMV grows | Tickets resolved, approvals SLA |
| BO-6 | Grow and retain both buyer and seller bases | Network effects | MAU, seller renewals, churn |
...
### 5.2 Out of Scope (Version 1 — candidates for later phases)
- End-to-end transactional e-commerce checkout / cart / order fulfilment (the platform is enquiry/lead-led, not order-led in V1)
- Integrated logistics / shipping execution
- Native mobile applications (assumed responsive web for V1 unless decided otherwise — **see open item OI-1**)
- Multi-currency settlement and international tax engines beyond GST
- AI-based automated lead scoring beyond the defined rule-based distribution (Product **Quality Score** is in scope; predictive lead scoring is not)
...
*End of Document — BRD v1.0 (Draft for Review)*
